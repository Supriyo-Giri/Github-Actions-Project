...
const Project = ({ title, projImg, projDesc, githubLink, demoLink }) => {
  return (
    <div className="project-card">
      ...
      <div className="project-content">
        ...
        <p className="project-desc">
          {projDesc} <br />
          <br />
          <span className="yellow-green"></span>
          ...
          {demoLink !== "" ? (
            <>
              <span className="yellow-green"> Demo link: </span>
              <a href={demoLink} className="link">
                click here
              </a>
            </>
          ) : null}
